...
import { BotIcon, SendIcon } from './components/IconComponents';
...
const App: React.FC = () => {
  ...
  const handleSlotSelect = (date: string, time: string) => {
     if (currentEventId) {
        const allEvents = messages.flatMap(m => m.eventData || []);
        const oldEvent = allEvents.find(e => e.id === currentEventId);
